...
export class Migrations1747141132471 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "${schema}"."promoter_member_status_enum" AS ENUM('active', 'inactive')`);
        await queryRunner.query(`CREATE TYPE "${schema}"."promoter_member_role_enum" AS ENUM('admin', 'editor', 'viewer')`);
        await queryRunner.query(`CREATE TABLE "promoter_member" ("promoter_id" uuid NOT NULL, "member_id" uuid NOT NULL, "status" "${schema}"."promoter_member_status_enum" NOT NULL DEFAULT 'active', "role" "${schema}"."promoter_member_role_enum" NOT NULL DEFAULT 'viewer', "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_6ceb1b5a3d8db6a61d86e795b2e" PRIMARY KEY ("promoter_id", "member_id"))`);
        await queryRunner.query(`CREATE TYPE "${schema}"."promoter_status_enum" AS ENUM('active', 'archived')`);
        await queryRunner.query(`CREATE TABLE "promoter" ("promoter_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "logo_url" character varying, "status" "${schema}"."promoter_status_enum" NOT NULL DEFAULT 'active', "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_f496acc776e708cae318d49c16a" PRIMARY KEY ("promoter_id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "${schema}"."condition_parameter_enum" AS ENUM('no. of signups', 'no. of purchases', 'item_id')`);
        await queryRunner.query(`CREATE TYPE "${schema}"."condition_operator_enum" AS ENUM('less_than_or_equal_to', 'less_than', 'equals', 'contains')`);
        await queryRunner.query(`CREATE TABLE "condition" ("condition_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "parameter" "${schema}"."condition_parameter_enum" NOT NULL, "operator" "${schema}"."condition_operator_enum" NOT NULL, "value" character varying NOT NULL, "function_id" uuid, CONSTRAINT "PK_842f840ae3a680df42ab08c8616" PRIMARY KEY ("condition_id"))`);
        await queryRunner.query(`CREATE TYPE "${schema}"."function_trigger_enum" AS ENUM('signup', 'purchase')`);
        await queryRunner.query(`CREATE TYPE "${schema}"."function_effect_type_enum" AS ENUM('switch_circle', 'generate_commission')`);
        await queryRunner.query(`CREATE TYPE "${schema}"."function_status_enum" AS ENUM('active', 'inactive')`);
        await queryRunner.query(`CREATE TABLE "function" ("function_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "trigger" "${schema}"."function_trigger_enum" NOT NULL, "effect_type" "${schema}"."function_effect_type_enum" NOT NULL DEFAULT 'generate_commission', "effect" jsonb NOT NULL, "status" "${schema}"."function_status_enum" NOT NULL DEFAULT 'active', "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "circle_id" uuid NOT NULL, "program_id" uuid NOT NULL, CONSTRAINT "PK_6129f598a8df4ea4aaadd8b929f" PRIMARY KEY ("function_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user" ("user_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying NOT NULL, "password" character varying NOT NULL, "first_name" character varying NOT NULL, "last_name" character varying NOT NULL, "role" "${schema}"."user_role_enum" NOT NULL DEFAULT 'regular', "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_758b8ce7c18b9d347461b30228d" PRIMARY KEY ("user_id"))`);
        await queryRunner.query(`CREATE TYPE "${schema}"."program_user_status_enum" AS ENUM('active', 'inactive')`);
        await queryRunner.query(`CREATE TYPE "${schema}"."program_user_role_enum" AS ENUM('super_admin', 'admin', 'editor', 'viewer', 'regular')`);
        await queryRunner.query(`CREATE TABLE "program_user" ("program_id" uuid NOT NULL, "user_id" uuid NOT NULL, "status" "${schema}"."program_user_status_enum" NOT NULL DEFAULT 'active', "role" "${schema}"."program_user_role_enum" NOT NULL DEFAULT 'viewer', "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_ca45ab30487a8daececdaa8a02f" PRIMARY KEY ("program_id", "user_id"))`);
        await queryRunner.query(`CREATE TYPE "${schema}"."api_key_status_enum" AS ENUM('active', 'inactive')`);
        await queryRunner.query(`CREATE TABLE "api_key" ("api_key_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "key" character varying NOT NULL, "secret" character varying NOT NULL, "status" "${schema}"."api_key_status_enum" NOT NULL DEFAULT 'active', "program_id" uuid NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT NOW(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT NOW(), CONSTRAINT "UQ_fb080786c16de6ace7ed0b69f7d" UNIQUE ("key"), CONSTRAINT "PK_febd1522b7c552bbe6987e7b51f" PRIMARY KEY ("api_key_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_fb080786c16de6ace7ed0b69f7" ON "api_key" ("key") `);
        await queryRunner.query(`CREATE TYPE "${schema}"."program_visibility_enum" AS ENUM('public', 'private')`);
        await queryRunner.query(`CREATE TYPE "${schema}"."program_referral_key_type_enum" AS ENUM('email', 'phone')`);
        await queryRunner.query(`CREATE TYPE "${schema}"."program_date_format_enum" AS ENUM('DD/MM/YYYY', 'YYYY/MM/DD', 'MM/DD/YYYY')`);
        await queryRunner.query(`CREATE TABLE "program" ("program_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "website" character varying NOT NULL, "visibility" "${schema}"."program_visibility_enum" NOT NULL DEFAULT 'public', "currency" character varying NOT NULL, "referral_key_type" "${schema}"."program_referral_key_type_enum" NOT NULL, "logo_url" character varying, "theme_color" character varying NOT NULL DEFAULT '', "terms_and_conditions" character varying NOT NULL DEFAULT '', "date_format" "${schema}"."program_date_format_enum" NOT NULL DEFAULT 'DD/MM/YYYY', "time_zone" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_53f58709c0270f634ebc233c52c" PRIMARY KEY ("program_id"))`);
        ...
        await queryRunner.query(`INSERT INTO "typeorm_metadata"("database", "schema", "table", "type", "name", "value") VALUES (DEFAULT, $1, DEFAULT, $2, $3, $4)`, [schema,"MATERIALIZED_VIEW","referral_mv","SELECT \"contact\".\"status\" AS \"status\", combined.program_id AS \"program_id\", combined.promoter_id AS \"promoter_id\", combined.contact_id AS \"contact_id\", SUM(combined.total_revenue) AS \"total_revenue\", SUM(combined.total_commission) AS \"total_commission\", MAX(combined.updated_at) AS \"updated_at\", MIN(combined.created_at) AS \"created_at\", \n\t\t\tCASE \n\t\t\tWHEN \"program\".\"referral_key_type\" = 'email' THEN \"contact\".\"email\" \n\t\t\tELSE \"contact\".\"phone\" \n\t\t\tEND\n\t\t AS \"contact_info\" FROM (\n\t\t(SELECT \"c\".\"program_id\" AS \"program_id\", \"pu\".\"promoter_id\" AS \"promoter_id\", \"c\".\"contact_id\" AS \"contact_id\", SUM(\"pu\".\"amount\") AS \"total_revenue\", 0 AS \"total_commission\", MAX(\"pu\".\"updated_at\") AS \"updated_at\", MIN(\"pu\".\"created_at\") AS \"created_at\" FROM \"contact\" \"c\" INNER JOIN \"purchase\" \"pu\" ON \"pu\".\"contact_id\" = \"c\".\"contact_id\" GROUP BY \"c\".\"program_id\", \"pu\".\"promoter_id\", \"c\".\"contact_id\") \n\t\tUNION ALL \n\t\t(SELECT \"c\".\"program_id\" AS \"program_id\", \"com\".\"promoter_id\" AS \"promoter_id\", \"c\".\"contact_id\" AS \"contact_id\", 0 AS \"total_revenue\", SUM(\"com\".\"amount\") AS \"total_commission\", MAX(\"com\".\"updated_at\") AS \"updated_at\", MIN(\"com\".\"created_at\") AS \"created_at\" FROM \"contact\" \"c\" INNER JOIN \"commission\" \"com\" ON \"com\".\"contact_id\" = \"c\".\"contact_id\" GROUP BY \"c\".\"program_id\", \"com\".\"promoter_id\", \"c\".\"contact_id\") \n\t\tUNION ALL \n\t\t(SELECT \"c\".\"program_id\" AS \"program_id\", \"su\".\"promoter_id\" AS \"promoter_id\", \"su\".\"contact_id\" AS \"contact_id\", 0 AS \"total_revenue\", 0 AS \"total_commission\", MAX(\"su\".\"updated_at\") AS \"updated_at\", MIN(\"su\".\"created_at\") AS \"created_at\" FROM \"sign_up\" \"su\" INNER JOIN \"contact\" \"c\" ON \"c\".\"contact_id\" = \"su\".\"contact_id\" GROUP BY \"c\".\"program_id\", \"su\".\"promoter_id\", \"su\".\"contact_id\")\n\t) \"combined\" INNER JOIN \"contact\" \"contact\" ON \"contact\".\"contact_id\" = combined.contact_id  INNER JOIN \"program\" \"program\" ON \"program\".\"program_id\" = combined.program_id GROUP BY combined.program_id, \"contact\".\"status\", combined.promoter_id, combined.contact_id, \"contact\".\"email\", \"contact\".\"phone\", \"program\".\"referral_key_type\""]);
        ...
        await queryRunner.query(`INSERT INTO "typeorm_metadata"("database", "schema", "table", "type", "name", "value") VALUES (DEFAULT, $1, DEFAULT, $2, $3, $4)`, [schema,"MATERIALIZED_VIEW","promoter_analytics_mv","SELECT \"pp\".\"program_id\" AS \"program_id\", \"pp\".\"promoter_id\" AS \"promoter_id\", COALESCE(rv.total_revenue, 0) AS \"total_revenue\", COALESCE(rv.total_commission, 0) AS \"total_commission\", COALESCE(su.total_signups, 0) AS \"total_signups\", COALESCE(pu.total_purchases, 0) AS \"total_purchases\" FROM \"program_promoter\" \"pp\" INNER JOIN \"promoter\" \"pr\" ON \"pp\".\"promoter_id\" = \"pr\".\"promoter_id\"  LEFT JOIN (SELECT \"rv\".\"program_id\" AS \"program_id\", \"rv\".\"promoter_id\" AS \"promoter_id\", SUM(\"rv\".\"total_revenue\") AS \"total_revenue\", SUM(\"rv\".\"total_commission\") AS \"total_commission\" FROM \"referral_mv\" \"rv\" GROUP BY \"rv\".\"program_id\", \"rv\".\"promoter_id\") \"rv\" ON rv.program_id = \"pp\".\"program_id\" AND rv.promoter_id = \"pp\".\"promoter_id\"  LEFT JOIN (SELECT \"c\".\"program_id\" AS \"program_id\", \"s\".\"promoter_id\" AS \"promoter_id\", COUNT(DISTINCT \"s\".\"contact_id\") AS \"total_signups\" FROM \"sign_up\" \"s\" INNER JOIN \"contact\" \"c\" ON \"s\".\"contact_id\" = \"c\".\"contact_id\" GROUP BY \"c\".\"program_id\", \"s\".\"promoter_id\") \"su\" ON su.program_id = \"pp\".\"program_id\" AND su.promoter_id = \"pp\".\"promoter_id\"  LEFT JOIN (SELECT \"c\".\"program_id\" AS \"program_id\", \"p\".\"promoter_id\" AS \"promoter_id\", COUNT(DISTINCT \"p\".\"purchase_id\") AS \"total_purchases\" FROM \"purchase\" \"p\" INNER JOIN \"contact\" \"c\" ON \"p\".\"contact_id\" = \"c\".\"contact_id\" GROUP BY \"c\".\"program_id\", \"p\".\"promoter_id\") \"pu\" ON pu.program_id = \"pp\".\"program_id\" AND pu.promoter_id = \"pp\".\"promoter_id\" WHERE \"pr\".\"status\" = 'active'"]);
        ...
        await queryRunner.query(`INSERT INTO "typeorm_metadata"("database", "schema", "table", "type", "name", "value") VALUES (DEFAULT, $1, DEFAULT, $2, $3, $4)`, [schema,"MATERIALIZED_VIEW","link_analytics_mv","SELECT \"l\".\"name\" AS \"name\", \"l\".\"link_id\" AS \"link_id\", \"l\".\"ref_val\" AS \"ref_val\", \"l\".\"program_id\" AS \"program_id\", \"l\".\"promoter_id\" AS \"promoter_id\", COALESCE(s.signups, 0) AS \"signups\", COALESCE(p.purchases, 0) AS \"purchases\", COALESCE(c.total_commission, 0) AS \"commission\", \"l\".\"created_at\" AS \"created_at\" FROM \"link\" \"l\" LEFT JOIN (SELECT \"s\".\"link_id\" AS \"link_id\", COUNT(\"s\".\"contact_id\") AS \"signups\" FROM \"sign_up\" \"s\" GROUP BY \"s\".\"link_id\") \"s\" ON s.link_id = \"l\".\"link_id\"  LEFT JOIN (SELECT \"pu\".\"link_id\" AS \"link_id\", COUNT(\"pu\".\"purchase_id\") AS \"purchases\" FROM \"purchase\" \"pu\" GROUP BY \"pu\".\"link_id\") \"p\" ON p.link_id = \"l\".\"link_id\"  LEFT JOIN (SELECT \"com\".\"link_id\" AS \"link_id\", SUM(\"com\".\"amount\") AS \"total_commission\" FROM \"commission\" \"com\" GROUP BY \"com\".\"link_id\") \"c\" ON c.link_id = \"l\".\"link_id\" WHERE \"l\".\"status\" = 'active'"]);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "${schema}"."IDX_7453c64b6153e538369ae9dc93"`);
        await queryRunner.query(`DROP INDEX "${schema}"."IDX_97e7f8a915668a2b2367f50de4"`);
        await queryRunner.query(`DROP INDEX "${schema}"."IDX_3fd775adfced33a6fedee275db"`);
        await queryRunner.query(`DROP INDEX "${schema}"."IDX_9e806f1e2e627bfa6c8b39b02f"`);
        await queryRunner.query(`DROP INDEX "${schema}"."IDX_88ca6797fd878bfd0557664e7d"`);
        await queryRunner.query(`DROP INDEX "${schema}"."IDX_b14e18b5c18a2284d0a3fd0172"`);
        await queryRunner.query(`DROP INDEX "${schema}"."IDX_9f1149620f218741615ee520f1"`);
        await queryRunner.query(`DROP INDEX "${schema}"."IDX_0bafbef03a91712f4525d7910b"`);
        await queryRunner.query(`DELETE FROM "typeorm_metadata" WHERE "type" = $1 AND "name" = $2 AND "schema" = $3`, ["MATERIALIZED_VIEW","link_analytics_mv",schema]);
        await queryRunner.query(`DROP MATERIALIZED VIEW "link_analytics_mv"`);
        await queryRunner.query(`DELETE FROM "typeorm_metadata" WHERE "type" = $1 AND "name" = $2 AND "schema" = $3`, ["MATERIALIZED_VIEW","promoter_analytics_mv",schema]);
        await queryRunner.query(`DROP MATERIALIZED VIEW "promoter_analytics_mv"`);
        await queryRunner.query(`DELETE FROM "typeorm_metadata" WHERE "type" = $1 AND "name" = $2 AND "schema" = $3`, ["MATERIALIZED_VIEW","referral_mv",schema]);
        ...
        await queryRunner.query(`DROP TYPE "${schema}"."program_date_format_enum"`);
        await queryRunner.query(`DROP TYPE "${schema}"."program_referral_key_type_enum"`);
        await queryRunner.query(`DROP TYPE "${schema}"."program_visibility_enum"`);
        await queryRunner.query(`DROP INDEX "${schema}"."IDX_fb080786c16de6ace7ed0b69f7"`);
        await queryRunner.query(`DROP TABLE "api_key"`);
        await queryRunner.query(`DROP TYPE "${schema}"."api_key_status_enum"`);
        await queryRunner.query(`DROP TABLE "program_user"`);
        await queryRunner.query(`DROP TYPE "${schema}"."program_user_role_enum"`);
        await queryRunner.query(`DROP TYPE "${schema}"."program_user_status_enum"`);
        ...
        await queryRunner.query(`DROP TYPE "${schema}"."function_status_enum"`);
        await queryRunner.query(`DROP TYPE "${schema}"."function_effect_type_enum"`);
        await queryRunner.query(`DROP TYPE "${schema}"."function_trigger_enum"`);
        ...
        await queryRunner.query(`DROP TYPE "${schema}"."promoter_status_enum"`);
        await queryRunner.query(`DROP TABLE "promoter_member"`);
        await queryRunner.query(`DROP TYPE "${schema}"."promoter_member_role_enum"`);
        await queryRunner.query(`DROP TYPE "${schema}"."promoter_member_status_enum"`);
        await queryRunner.query(`DROP TABLE "member"`);
        await queryRunner.query(`DROP TABLE "program_promoter"`);
        await queryRunner.query(`DROP TABLE "sign_up"`);
        await queryRunner.query(`DROP INDEX "${schema}"."IDX_799c56c4ad5e38b97afe9dad8d"`);
        await queryRunner.query(`DROP TABLE "link"`);
        await queryRunner.query(`DROP TYPE "${schema}"."link_status_enum"`);
        await queryRunner.query(`DROP TABLE "purchase"`);
        await queryRunner.query(`DROP TABLE "contact"`);
        await queryRunner.query(`DROP TYPE "${schema}"."contact_status_enum"`);
        await queryRunner.query(`DROP TABLE "commission"`);
        await queryRunner.query(`DROP TYPE "${schema}"."commission_conversion_type_enum"`);
    }
