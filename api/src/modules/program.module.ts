...
@Module({
	...
	providers: [ProgramService, ProgramConverter, ProgramAnalyticsConverter, ProgramSummaryViewWorkbookConverter, PromoterAnalyticsConverter, ProgramPromoterService],
