...
import { ProgramSummaryViewConverter } from 'src/converters/program/program_summary_view.workbook.converter';
...
@Module({
	...
	providers: [ProgramService, ProgramConverter, ProgramAnalyticsConverter, ProgramSummaryViewConverter, PromoterAnalyticsConverter, ProgramPromoterService],
