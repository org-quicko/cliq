import { IsString, IsArray, ValidateNested, IsEnum, IsOptional, IsUUID, IsDate, IsDefined } from 'class-validator';
...
import { Effect, GenerateCommissionEffect, SwitchCircleEffect } from '../entities';
